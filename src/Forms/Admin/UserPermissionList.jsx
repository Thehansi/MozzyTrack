...
// export class NumberSeriesList extends Component {
//   constructor(props) {
//     super(props);
...
//             <Modal.Title>List of Number Series</Modal.Title>
//           </Modal.Header>
//           <Modal.Body>
//             <DataGrid
//               id="grid-list"
//               dataSource={this.props.Exam}
//               keyExpr="AutoID"
//               showBorders={true}
...
//               <Column dataField="Name" width="200" />
//               <Column dataField="Description" width="300" />

//               <Column dataField="Document" width="200" />
//             </DataGrid>
