        ...
        if (this.OnSaveValidation()) {
            if (this.state.File) {
                this.setState({ LoadPanelVisible: true }, () => {
                    ...
                    var ext = /(?:\.([^.]+))?$/;
                    let FileName = (this.props.FileInfo.Name + "_" + uuid.v4() + "." + ext.exec(this.state.File.name)[1]).replaceAll(/\s/g, '');
                    debugger
                    axios
                        ...
                        .then((response) => {
                            ...
                            this.props.OnHide(0, FileName, response.data.filePath, this.props.FileInfo.AttachmentID);
                        })
                        .catch((error) => {
                            console.log(error);
            ...
            } else if (this.props.FileInfo.AttachmentID) {
